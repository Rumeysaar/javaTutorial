...
class BOA {
    public static void main(String[] args) {
       ...
       ScrumTeam [] testersArr = {tester1,tester2,tester3};
        ...
        Developers developer1 = new Developers("Ahmet", "Developer",8000);
        Developers developer2 = new Developers("Mehmet", "Developer",10000);
        Developers developer3 = new Developers("Safak", "Developer",9000);
