...
class Sekil {
    void ciz() {
        System.out.println("bir sekil ciz");
    }
    ...
    class Daire extends Sekil {
        void ciz() {
            System.out.println("bir daire ciz");
        }
        void daire() {
    ...
    class Kare extends Sekil {
        void ciz() {
            System.out.println("bir kare ciz");
        }
...
public class C01_Polymorphism {
    public static void main(String[] args) {
        ...
        sekil.sekil();//bir sekil cizen metod
        sekil.ciz();// bir sekil ciz
        daire.ciz();
        daire.sekil();
        ((Daire)daire).daire();
        //CTE daire.daire
